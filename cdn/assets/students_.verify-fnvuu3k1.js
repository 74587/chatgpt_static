import{n as e,s as t}from"./f025431a-ehagpvg3m4e1cduv.js";import{Cq as n,GI as r,Gj as i,HJ as a,Ket as o,Kj as s,Sq as c,VJ as l,ZK as u,brt as d,gq as f,hq as p,qI as m,qet as ee,rq as h}from"./4813494d-1a64rqvp3ruwzfd7.js";import{At as g,Bn as _,Ht as te,Ln as v,Nn as y,Pt as ne,Q as re,Rn as ie,Ut as ae,Vn as b,Wt as oe,wn as x,zn as se}from"./2340486e-b3t78qt0psmq9d8c.js";import{A1t as ce,Ikt as le,Lkt as S,On as ue,bn as de,j1t as C,kn as fe}from"./conversation-small-i1febo351kdbaguv.js";import{_y as pe,vy as w}from"./30901919-fhpwp2ofonvo8mms.js";import{Gm as me,Jm as he,Qm as ge,Um as _e,Wm as ve,eh as T,qm as ye}from"./c2675c8c-uk1xiyq9q78q04t2.js";import{n as be,t as xe}from"./6105d6cc-e9r3ybhg5mr1msc8.js";import{n as E,t as Se}from"./9bfdcf20-ogp2boie20peecki.js";import{a as Ce,d as D,f as we,l as O,n as Te,o as Ee,r as k,t as A,u as De}from"./d4df9516-jqnc9d4zxaeffhzi.js";import{n as j,t as M}from"./759cd6d0-h5voil3v9832824d.js";function N(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function P(e,t){try{let n=new URL(e);return n.origin!==z||n.username!==``||n.password!==``||!/^\/verify\/[^/]+\/?$/.test(n.pathname)||n.searchParams.getAll(`verificationId`).length!==1||n.searchParams.get(`verificationId`)!==t?null:(n.hash=``,n)}catch{return null}}function Oe(){let e=new URL(window.location.origin);return e.pathname=window.location.pathname,e.searchParams.set(`campaign`,ge),e}function ke(e){e.contentWindow?.postMessage({action:`setOptions`,options:{customCss:`${V}${H}`}},z)}function Ae(e){"use forget";let t=(0,I.c)(21),{verificationUrl:n,verificationId:r,onSubmitted:i,onSuccess:o}=e,s=se(),c=a(),l=(0,L.useRef)(null),u=(0,L.useRef)(null),[d]=(0,L.useState)(je),f;if(t[0]!==d||t[1]!==c||t[2]!==r||t[3]!==n){bb0:{if(!c||d==null){f=null;break bb0}let e=P(n,r);if(e==null){f=null;break bb0}e.searchParams.set(`verificationIframeUid`,d),e.searchParams.set(`installPageUrl`,Oe().toString()),e.searchParams.set(`installType`,`cdn_inline_iframe`),f=e.toString()}t[0]=d,t[1]=c,t[2]=r,t[3]=n,t[4]=f}else f=t[4];let p=f,m,ee;if(t[5]!==d||t[6]!==p||t[7]!==i||t[8]!==o||t[9]!==r?(m=()=>{if(d==null||p==null)return;let e=e=>{let t=l.current;if(t==null||e.origin!==z||e.source!==t.contentWindow||!N(e.data)||e.data.verificationIframeUid!==d)return;let n=e.data.action;if(N(n)&&n.type===`updateHeight`){if(typeof n.height!=`number`||!Number.isFinite(n.height))return;let e=Math.min(B,Math.max(Me,Math.round(n.height)));t.style.height=`${e}px`,t.scrolling=n.height>B?`auto`:`no`;return}if(!N(n)||n.type!==`hook`||!N(n.hook)||!N(n.hook.data)||n.hook.data.verificationId!==r)return;let a=n.hook.data.currentStep,s=n.hook.name===`ON_VERIFICATION_STEP_CHANGE`&&typeof a==`string`&&a!==`collectStudentPersonalInfo`&&a!==`collectPersonalInfo`,c=n.hook.name===`ON_VERIFICATION_SUCCESS`&&a===`success`;if(!(!s&&!c)){if(u.current!==r){u.current=r;try{i?.()}catch{}}c&&o()}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},ee=[d,p,i,o,r],t[5]=d,t[6]=p,t[7]=i,t[8]=o,t[9]=r,t[10]=m,t[11]=ee):(m=t[10],ee=t[11]),(0,L.useEffect)(m,ee),p==null){let e;t[12]===s?e=t[13]:(e=s.formatMessage(U.loadingLabel),t[12]=s,t[13]=e);let n;return t[14]===e?n=t[15]:(n=(0,R.jsx)(`div`,{"aria-busy":`true`,"aria-label":e,className:`min-h-[100px] w-full`,role:`status`}),t[14]=e,t[15]=n),n}let h;t[16]===s?h=t[17]:(h=s.formatMessage(U.verificationTitle),t[16]=s,t[17]=h);let g;return t[18]!==p||t[19]!==h?(g=(0,R.jsx)(`iframe`,{ref:l,allow:`camera ${z}`,className:`block min-h-[100px] w-full border-0`,onLoad:F,referrerPolicy:`no-referrer`,src:p,title:h}),t[18]=p,t[19]=h,t[20]=g):g=t[20],g}function F(e){ke(e.currentTarget)}function je(){return typeof window>`u`?null:globalThis.crypto.randomUUID()}var I,L,R,z,Me,B,V,H,U,Ne=e((()=>{I=x(),T(),l(),L=t(b()),ie(),R=_(),z=`https://services.sheerid.com`,Me=100,B=2e3,V=`
