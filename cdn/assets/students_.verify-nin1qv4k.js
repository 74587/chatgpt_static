import{n as e,s as t}from"./f025431a-ehagpvg3m4e1cduv.js";import{B0 as n,Cit as r,Dtt as i,Ett as a,O$ as o,S$ as s,V0 as c,gL as l,hM as ee,k$ as u,l$ as d,mM as f,r$ as te,vL as p,x$ as m}from"./4813494d-eu29r5c5isg74cf4.js";import{Bn as ne,Ft as h,Gt as g,Hn as _,Pn as v,Q as y,Rn as re,Tn as ie,Ut as ae,Vn as b,Wt as oe,jt as se,zn as ce}from"./2340486e-cvl0axudepa7gku6.js";import{Mn as le,Nn as x,Tkt as S,d1t as ue,u1t as de,wkt as fe,wn as pe}from"./conversation-small-cgu6htgninz28hb1.js";import{by as me,yy as he}from"./30901919-e870ap3jr2mcyop0.js";import{Qm as ge,Xm as _e,Zm as ve,ah as ye,eh as be,sh as C,th as xe}from"./c2675c8c-cqu4f5pciwgx66pt.js";import{n as w,t as Se}from"./6105d6cc-edh9bv4eaeep4uh7.js";import{n as T,t as Ce}from"./9bfdcf20-jxl7th1lvin1eq13.js";import{a as we,d as E,f as Te,l as D,n as Ee,o as De,r as O,t as k,u as Oe}from"./d4df9516-fd0sf7rq5pk2mf50.js";import{n as A,t as j}from"./759cd6d0-kzpct7ece86kun0r.js";function M(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function N(e,t){try{let n=new URL(e);return n.origin!==z||n.username!==``||n.password!==``||!/^\/verify\/[^/]+\/?$/.test(n.pathname)||n.searchParams.getAll(`verificationId`).length!==1||n.searchParams.get(`verificationId`)!==t?null:(n.hash=``,n)}catch{return null}}function P(){let e=new URL(window.location.origin);return e.pathname=window.location.pathname,e.searchParams.set(`campaign`,ye),e}function F(e){e.contentWindow?.postMessage({action:`setOptions`,options:{customCss:`${V}${H}`}},z)}function ke(e){"use forget";let t=(0,I.c)(21),{verificationUrl:n,verificationId:r,onSubmitted:i,onSuccess:a}=e,o=ne(),s=c(),l=(0,L.useRef)(null),ee=(0,L.useRef)(null),[u]=(0,L.useState)(je),d;if(t[0]!==u||t[1]!==s||t[2]!==r||t[3]!==n){bb0:{if(!s||u==null){d=null;break bb0}let e=N(n,r);if(e==null){d=null;break bb0}e.searchParams.set(`verificationIframeUid`,u),e.searchParams.set(`installPageUrl`,P().toString()),e.searchParams.set(`installType`,`cdn_inline_iframe`),d=e.toString()}t[0]=u,t[1]=s,t[2]=r,t[3]=n,t[4]=d}else d=t[4];let f=d,te,p;if(t[5]!==u||t[6]!==f||t[7]!==i||t[8]!==a||t[9]!==r?(te=()=>{if(u==null||f==null)return;let e=e=>{let t=l.current;if(t==null||e.origin!==z||e.source!==t.contentWindow||!M(e.data)||e.data.verificationIframeUid!==u)return;let n=e.data.action;if(M(n)&&n.type===`updateHeight`){if(typeof n.height!=`number`||!Number.isFinite(n.height))return;let e=Math.min(B,Math.max(Me,Math.round(n.height)));t.style.height=`${e}px`,t.scrolling=n.height>B?`auto`:`no`;return}if(!M(n)||n.type!==`hook`||!M(n.hook)||!M(n.hook.data)||n.hook.data.verificationId!==r)return;let o=n.hook.data.currentStep,s=n.hook.name===`ON_VERIFICATION_STEP_CHANGE`&&typeof o==`string`&&o!==`collectStudentPersonalInfo`&&o!==`collectPersonalInfo`,c=n.hook.name===`ON_VERIFICATION_SUCCESS`&&o===`success`;if(!(!s&&!c)){if(ee.current!==r){ee.current=r;try{i?.()}catch{}}c&&a()}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},p=[u,f,i,a,r],t[5]=u,t[6]=f,t[7]=i,t[8]=a,t[9]=r,t[10]=te,t[11]=p):(te=t[10],p=t[11]),(0,L.useEffect)(te,p),f==null){let e;t[12]===o?e=t[13]:(e=o.formatMessage(U.loadingLabel),t[12]=o,t[13]=e);let n;return t[14]===e?n=t[15]:(n=(0,R.jsx)(`div`,{"aria-busy":`true`,"aria-label":e,className:`min-h-[100px] w-full`,role:`status`}),t[14]=e,t[15]=n),n}let m;t[16]===o?m=t[17]:(m=o.formatMessage(U.verificationTitle),t[16]=o,t[17]=m);let h;return t[18]!==f||t[19]!==m?(h=(0,R.jsx)(`iframe`,{ref:l,allow:`camera ${z}`,className:`block min-h-[100px] w-full border-0`,onLoad:Ae,referrerPolicy:`no-referrer`,src:f,title:m}),t[18]=f,t[19]=m,t[20]=h):h=t[20],h}function Ae(e){F(e.currentTarget)}function je(){return typeof window>`u`?null:globalThis.crypto.randomUUID()}var I,L,R,z,Me,B,V,H,U,Ne=e((()=>{I=ie(),C(),n(),L=t(_()),ce(),R=b(),z=`https://services.sheerid.com`,Me=100,B=2e3,V=`
