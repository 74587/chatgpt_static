import{n as e,s as t}from"./f025431a-ehagpvg3m4e1cduv.js";import{BP as n,FK as r,H7 as i,Lk as a,PK as o,RP as s,Rk as c,U7 as l,WW as u,XW as d,cG as f,gG as p,gtt as ee,hG as m,lG as h}from"./4813494d-dsp6bzwclkpos9fb.js";import{At as g,Bn as _,Ht as te,Ln as v,Nn as y,Pt as ne,Q as re,Rn as ie,Ut as ae,Vn as b,Wt as oe,wn as x,zn as se}from"./2340486e-b3t78qt0psmq9d8c.js";import{J1t as S,On as ce,bn as le,kn as C,nAt as ue,q1t as de,tAt as fe}from"./conversation-small-hcbe4nlf7fw13ckt.js";import{_y as pe,vy as w}from"./30901919-pbt5kapmbgv7tb1v.js";import{Am as me,Im as he,Mm as ge,Om as _e,Rm as T,jm as ve,km as E}from"./c2675c8c-mfxoyhrovqqy98to.js";import{n as ye,t as be}from"./6105d6cc-dscpfk6701oytwpm.js";import{n as D,t as xe}from"./9bfdcf20-c5izrnwskpcpae2y.js";import{a as Se,d as Ce,f as we,l as O,n as Te,o as Ee,r as k,t as A,u as De}from"./d4df9516-bm96xwx47ifggmos.js";import{n as j,t as M}from"./759cd6d0-fowi9cotqqkzwrtr.js";function N(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function P(e,t){try{let n=new URL(e);return n.origin!==z||n.username!==``||n.password!==``||!/^\/verify\/[^/]+\/?$/.test(n.pathname)||n.searchParams.getAll(`verificationId`).length!==1||n.searchParams.get(`verificationId`)!==t?null:(n.hash=``,n)}catch{return null}}function F(){let e=new URL(window.location.origin);return e.pathname=window.location.pathname,e.searchParams.set(`campaign`,he),e}function Oe(e){e.contentWindow?.postMessage({action:`setOptions`,options:{customCss:`${V}${H}`}},z)}function ke(e){"use forget";let t=(0,I.c)(21),{verificationUrl:n,verificationId:i,onSubmitted:a,onSuccess:o}=e,s=se(),c=r(),l=(0,L.useRef)(null),u=(0,L.useRef)(null),[d]=(0,L.useState)(je),f;if(t[0]!==d||t[1]!==c||t[2]!==i||t[3]!==n){bb0:{if(!c||d==null){f=null;break bb0}let e=P(n,i);if(e==null){f=null;break bb0}e.searchParams.set(`verificationIframeUid`,d),e.searchParams.set(`installPageUrl`,F().toString()),e.searchParams.set(`installType`,`cdn_inline_iframe`),f=e.toString()}t[0]=d,t[1]=c,t[2]=i,t[3]=n,t[4]=f}else f=t[4];let p=f,ee,m;if(t[5]!==d||t[6]!==p||t[7]!==a||t[8]!==o||t[9]!==i?(ee=()=>{if(d==null||p==null)return;let e=e=>{let t=l.current;if(t==null||e.origin!==z||e.source!==t.contentWindow||!N(e.data)||e.data.verificationIframeUid!==d)return;let n=e.data.action;if(N(n)&&n.type===`updateHeight`){if(typeof n.height!=`number`||!Number.isFinite(n.height))return;let e=Math.min(B,Math.max(Me,Math.round(n.height)));t.style.height=`${e}px`,t.scrolling=n.height>B?`auto`:`no`;return}if(!N(n)||n.type!==`hook`||!N(n.hook)||!N(n.hook.data)||n.hook.data.verificationId!==i)return;let r=n.hook.data.currentStep,s=n.hook.name===`ON_VERIFICATION_STEP_CHANGE`&&typeof r==`string`&&r!==`collectStudentPersonalInfo`&&r!==`collectPersonalInfo`,c=n.hook.name===`ON_VERIFICATION_SUCCESS`&&r===`success`;if(!(!s&&!c)){if(u.current!==i){u.current=i;try{a?.()}catch{}}c&&o()}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},m=[d,p,a,o,i],t[5]=d,t[6]=p,t[7]=a,t[8]=o,t[9]=i,t[10]=ee,t[11]=m):(ee=t[10],m=t[11]),(0,L.useEffect)(ee,m),p==null){let e;t[12]===s?e=t[13]:(e=s.formatMessage(U.loadingLabel),t[12]=s,t[13]=e);let n;return t[14]===e?n=t[15]:(n=(0,R.jsx)(`div`,{"aria-busy":`true`,"aria-label":e,className:`min-h-[100px] w-full`,role:`status`}),t[14]=e,t[15]=n),n}let h;t[16]===s?h=t[17]:(h=s.formatMessage(U.verificationTitle),t[16]=s,t[17]=h);let g;return t[18]!==p||t[19]!==h?(g=(0,R.jsx)(`iframe`,{ref:l,allow:`camera ${z}`,className:`block min-h-[100px] w-full border-0`,onLoad:Ae,referrerPolicy:`no-referrer`,src:p,title:h}),t[18]=p,t[19]=h,t[20]=g):g=t[20],g}function Ae(e){Oe(e.currentTarget)}function je(){return typeof window>`u`?null:globalThis.crypto.randomUUID()}var I,L,R,z,Me,B,V,H,U,Ne=e((()=>{I=x(),T(),o(),L=t(b()),ie(),R=_(),z=`https://services.sheerid.com`,Me=100,B=2e3,V=`
