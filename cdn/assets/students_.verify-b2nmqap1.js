import{n as e,s as t}from"./f025431a-ehagpvg3m4e1cduv.js";import{EG as n,G5 as r,Hk as i,K5 as a,MG as o,NG as s,QK as c,TG as l,Uk as ee,ZK as u,cG as d,iF as f,nF as p,pG as m,yet as h}from"./4813494d-gycm0sx6lon4voy5.js";import{At as g,Bn as _,Ht as te,Ln as v,Nn as y,Pt as ne,Q as re,Rn as ie,Ut as ae,Vn as b,Wt as oe,wn as x,zn as se}from"./2340486e-b3t78qt0psmq9d8c.js";import{C1t as S,Gkt as ce,Kkt as C,On as le,S1t as ue,bn as de,kn as fe}from"./conversation-small-f8ygwl0g2zcxhtqg.js";import{gy as pe,hy as me}from"./30901919-iktpevfzn1o5ayjd.js";import{Dm as he,Em as ge,Fm as w,Nm as _e,Om as ve,Tm as ye,km as be}from"./c2675c8c-m1rnozbbzqu2jn6o.js";import{n as xe,t as Se}from"./6105d6cc-hq37n3j13mv4qqi2.js";import{n as T,t as Ce}from"./9bfdcf20-gi4pxhf72przkfxn.js";import{a as we,d as E,f as Te,l as D,n as Ee,o as De,r as O,t as k,u as Oe}from"./d4df9516-f2vg7sdeqsqpbx31.js";import{n as A,t as j}from"./759cd6d0-42mldttn0c5syey4.js";function M(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function N(e,t){try{let n=new URL(e);return n.origin!==z||n.username!==``||n.password!==``||!/^\/verify\/[^/]+\/?$/.test(n.pathname)||n.searchParams.getAll(`verificationId`).length!==1||n.searchParams.get(`verificationId`)!==t?null:(n.hash=``,n)}catch{return null}}function P(){let e=new URL(window.location.origin);return e.pathname=window.location.pathname,e.searchParams.set(`campaign`,_e),e}function F(e){e.contentWindow?.postMessage({action:`setOptions`,options:{customCss:`${V}${H}`}},z)}function ke(e){"use forget";let t=(0,I.c)(21),{verificationUrl:n,verificationId:r,onSubmitted:i,onSuccess:a}=e,o=se(),s=c(),l=(0,L.useRef)(null),ee=(0,L.useRef)(null),[u]=(0,L.useState)(je),d;if(t[0]!==u||t[1]!==s||t[2]!==r||t[3]!==n){bb0:{if(!s||u==null){d=null;break bb0}let e=N(n,r);if(e==null){d=null;break bb0}e.searchParams.set(`verificationIframeUid`,u),e.searchParams.set(`installPageUrl`,P().toString()),e.searchParams.set(`installType`,`cdn_inline_iframe`),d=e.toString()}t[0]=u,t[1]=s,t[2]=r,t[3]=n,t[4]=d}else d=t[4];let f=d,p,m;if(t[5]!==u||t[6]!==f||t[7]!==i||t[8]!==a||t[9]!==r?(p=()=>{if(u==null||f==null)return;let e=e=>{let t=l.current;if(t==null||e.origin!==z||e.source!==t.contentWindow||!M(e.data)||e.data.verificationIframeUid!==u)return;let n=e.data.action;if(M(n)&&n.type===`updateHeight`){if(typeof n.height!=`number`||!Number.isFinite(n.height))return;let e=Math.min(B,Math.max(Me,Math.round(n.height)));t.style.height=`${e}px`,t.scrolling=n.height>B?`auto`:`no`;return}if(!M(n)||n.type!==`hook`||!M(n.hook)||!M(n.hook.data)||n.hook.data.verificationId!==r)return;let o=n.hook.data.currentStep,s=n.hook.name===`ON_VERIFICATION_STEP_CHANGE`&&typeof o==`string`&&o!==`collectStudentPersonalInfo`&&o!==`collectPersonalInfo`,c=n.hook.name===`ON_VERIFICATION_SUCCESS`&&o===`success`;if(!(!s&&!c)){if(ee.current!==r){ee.current=r;try{i?.()}catch{}}c&&a()}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},m=[u,f,i,a,r],t[5]=u,t[6]=f,t[7]=i,t[8]=a,t[9]=r,t[10]=p,t[11]=m):(p=t[10],m=t[11]),(0,L.useEffect)(p,m),f==null){let e;t[12]===o?e=t[13]:(e=o.formatMessage(U.loadingLabel),t[12]=o,t[13]=e);let n;return t[14]===e?n=t[15]:(n=(0,R.jsx)(`div`,{"aria-busy":`true`,"aria-label":e,className:`min-h-[100px] w-full`,role:`status`}),t[14]=e,t[15]=n),n}let h;t[16]===o?h=t[17]:(h=o.formatMessage(U.verificationTitle),t[16]=o,t[17]=h);let g;return t[18]!==f||t[19]!==h?(g=(0,R.jsx)(`iframe`,{ref:l,allow:`camera ${z}`,className:`block min-h-[100px] w-full border-0`,onLoad:Ae,referrerPolicy:`no-referrer`,src:f,title:h}),t[18]=f,t[19]=h,t[20]=g):g=t[20],g}function Ae(e){F(e.currentTarget)}function je(){return typeof window>`u`?null:globalThis.crypto.randomUUID()}var I,L,R,z,Me,B,V,H,U,Ne=e((()=>{I=x(),w(),u(),L=t(b()),ie(),R=_(),z=`https://services.sheerid.com`,Me=100,B=2e3,V=`
...
`,U=v({loadingLabel:{id:`chatgpt.students.back_to_school_2026.embedded_form.loading`,defaultMessage:`Loading student verification`},verificationTitle:{id:`chatgpt.students.back_to_school_2026.embedded_form.title`,defaultMessage:`Student verification`}})}));function Pe(e){"use forget";let t=(0,Re.c)(8),{sheerIdProgramId:r}=e,i=n(),a=i?.id??null,o=(0,W.useRef)(a),s,c;t[0]===a?(s=t[1],c=t[2]):(s=()=>{if(a==null)return;let e=o.current;o.current=a,e!=null&&e!==a&&(k.clearModalError(),k.setIsLoading(!1))},c=[a],t[0]=a,t[1]=s,t[2]=c),ee(s,c);let l;t[3]===Symbol.for(`react.memo_cache_sentinel`)?(l=[],t[3]=l):l=t[3],(0,W.useEffect)(Fe,l);let u=i?.id??`no-account`,d;return t[4]!==i||t[5]!==r||t[6]!==u?(d=(0,G.jsx)(Le,{currentAccount:i,sheerIdProgramId:r},u),t[4]=i,t[5]=r,t[6]=u,t[7]=d):d=t[7],d}function Fe(){let e=Ie;return window.addEventListener(`pageshow`,e),()=>window.removeEventListener(`pageshow`,e)}function Ie(e){e.persisted&&window.location.reload()}function Le(e){"use forget";let t=(0,Re.c)(97),{currentAccount:n,sheerIdProgramId:r}=e,i=se(),o=ne(),c=l(),u=f(),[p]=te(),m;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(m=a(),t[0]=m):m=t[0];let g=m,_;t[1]===p?_=t[2]:(_=()=>{he(p)},t[1]=p,t[2]=_);let v;t[3]!==n||t[4]!==p?(v=[p,n,g],t[3]=n,t[4]=p,t[5]=v):v=t[5],ee(_,v);let re=(0,W.useRef)(!1),ie=(0,W.useRef)(!1),ae=(0,W.useRef)(!0),b;t[6]===p?b=t[7]:(b=p.get(Be),t[6]=p,t[7]=b);let oe=b,x=`/students/2026#trigger_students-2026-faq-verification`,S;t[8]===oe?S=t[9]:(S=new URLSearchParams({campaign:_e}).toString(),t[8]=oe,t[9]=S);let C=`/students/claim?${S}`,fe;t[10]===u?.email?fe=t[11]:(fe=g&&(u?.email?.trim()||h()?.user?.email?.trim())||null,t[10]=u?.email,t[11]=fe);let pe=fe,ge;t[12]!==C||t[13]!==r?(ge={...be,landingPath:C,sheerIdProgramId:r},t[12]=C,t[13]=r,t[14]=ge):ge=t[14];let w=ge,xe;t[15]!==n||t[16]!==w?(xe=n!=null&&(Oe(n)||!n.isPersonalAccount()||w.blocksMobileStoreSubscribers&&ue(n)),t[15]=n,t[16]=w,t[17]=xe):xe=t[17];let T=xe,Ce=g&&n!=null&&!T,E;t[18]===Ce?E=t[19]:(E={enabled:Ce,reportRefreshErrors:!0},t[18]=Ce,t[19]=E);let D=Te(w,E),O=D.name===`needs-verification`?D.verificationId??null:null,k=D.name===`needs-verification`?D.accountVerificationId??null:null,A=De(O,k,w),j,M;t[20]===Symbol.for(`react.memo_cache_sentinel`)?(j=()=>(ae.current=!0,()=>{ae.current=!1}),M=[],t[20]=j,t[21]=M):(j=t[20],M=t[21]),(0,W.useEffect)(j,M);let N,P;t[22]===C?(N=t[23],P=t[24]):(N=()=>{g||re.current||(re.current=!0,s({callbackUrl:ye(C),fallbackScreenHint:`login`}))},P=[C,g],t[22]=C,t[23]=N,t[24]=P),(0,W.useEffect)(N,P);let F;t[25]!==c.isError||t[26]!==c.isFetching||t[27]!==c.isSuccess||t[28]!==C||t[29]!==n||t[30]!==D.name||t[31]!==T||t[32]!==o?(F=()=>{if(!g)return;let e=n==null&&!c.isFetching&&(c.isError||c.isSuccess),t=D.name===`coming-soon`||D.name===`error`||D.name===`verified`||D.name===`enrolled`;(e||T||t)&&o(C,{replace:!0})},t[25]=c.isError,t[26]=c.isFetching,t[27]=c.isSuccess,t[28]=C,t[29]=n,t[30]=D.name,t[31]=T,t[32]=o,t[33]=F):F=t[33];let Ae;t[34]!==c.isError||t[35]!==c.isFetching||t[36]!==c.isSuccess||t[37]!==C||t[38]!==n||t[39]!==D||t[40]!==T||t[41]!==o?(Ae=[c.isError,c.isFetching,c.isSuccess,C,n,D,T,g,o],t[34]=c.isError,t[35]=c.isFetching,t[36]=c.isSuccess,t[37]=C,t[38]=n,t[39]=D,t[40]=T,t[41]=o,t[42]=Ae):Ae=t[42],(0,W.useEffect)(F,Ae);let je,I;t[43]!==k||t[44]!==C||t[45]!==n||t[46]!==D.name||t[47]!==T||t[48]!==o||t[49]!==O||t[50]!==A?(je=()=>{!g||n==null||T||D.name!==`needs-verification`||O!=null&&k!=null||ie.current||(ie.current=!0,A().then(()=>{!ae.current||d()?.id!==n.id||we.getState().modalErrorMessage==null||o(C,{replace:!0,state:{students2026VerificationError:!0}})}))},I=[k,C,n,D.name,T,g,o,O,A],t[43]=k,t[44]=C,t[45]=n,t[46]=D.name,t[47]=T,t[48]=o,t[49]=O,t[50]=A,t[51]=je,t[52]=I):(je=t[51],I=t[52]),(0,W.useEffect)(je,I);let L;t[53]===n?L=t[54]:(L=()=>{let e=n?.normalizedAccountUserId;n==null||typeof e!=`string`||ve(`verification_submitted`,{identity:{accountId:n.id,accountUserId:e}})},t[53]=n,t[54]=L);let R=L,z;t[55]!==C||t[56]!==o?(z=()=>{o(le(C,de),{replace:!0})},t[55]=C,t[56]=o,t[57]=z):z=t[57];let Me=z,B;t[58]!==k||t[59]!==C||t[60]!==n||t[61]!==T||t[62]!==r||t[63]!==O?(B=g&&n!=null&&O&&k&&!T?Ee(r,`${window.location.origin}${le(C,de)}`,O,k):null,t[58]=k,t[59]=C,t[60]=n,t[61]=T,t[62]=r,t[63]=O,t[64]=B):B=t[64];let V=B,H;t[65]===i?H=t[66]:(H=i.formatMessage(K.artworkAlt),t[65]=i,t[66]=H);let U;t[67]===H?U=t[68]:(U=(0,G.jsx)(Se,{altText:H,assetUrl:ze,mediaClassName:`h-full w-full object-cover`,rounding:`none`,wrapperClassName:`order-first h-[228px] w-full lg:order-last lg:mt-14 lg:h-[456px] lg:rounded-[32px]`}),t[67]=H,t[68]=U);let Ne;t[69]===Symbol.for(`react.memo_cache_sentinel`)?(Ne=(0,G.jsx)(`span`,{className:`lg:hidden`,children:(0,G.jsx)(y,{...K.title})}),t[69]=Ne):Ne=t[69];let Pe;t[70]===Symbol.for(`react.memo_cache_sentinel`)?(Pe=(0,G.jsxs)(`h1`,{className:`text-token-text-primary text-[32px] leading-[1.14] font-medium tracking-[-0.64px] lg:text-[64px] lg:leading-none lg:tracking-[-1.28px]`,children:[Ne,(0,G.jsx)(`span`,{className:`hidden lg:inline`,children:(0,G.jsx)(y,{...K.desktopTitle})})]}),t[70]=Pe):Pe=t[70];let Fe;t[71]===Symbol.for(`react.memo_cache_sentinel`)?(Fe=(0,G.jsx)(`span`,{className:`lg:hidden`,children:(0,G.jsx)(y,{...K.description})}),t[71]=Fe):Fe=t[71];let Ie;t[72]===Symbol.for(`react.memo_cache_sentinel`)?(Ie=(0,G.jsx)(`span`,{className:`hidden lg:inline`,children:(0,G.jsx)(y,{...K.desktopDescription})}),t[72]=Ie):Ie=t[72];let Le;t[73]===Symbol.for(`react.memo_cache_sentinel`)?(Le=(0,G.jsx)(y,{...K.verificationHelp}),t[73]=Le):Le=t[73];let q;t[74]===x?q=t[75]:(q=(0,G.jsxs)(`div`,{className:`px-8 pt-8 lg:px-0 lg:pt-0`,children:[Pe,(0,G.jsxs)(`p`,{className:`text-token-text-secondary mt-6 text-base leading-[26px]`,children:[Fe,Ie,(0,G.jsx)(`a`,{className:`text-token-text-secondary ms-1 underline underline-offset-2`,href:x,rel:`noopener noreferrer`,target:`_blank`,children:Le})]})]}),t[74]=x,t[75]=q);let J;t[76]!==U||t[77]!==q?(J=(0,G.jsxs)(`section`,{className:`flex min-w-0 flex-col`,children:[U,q]}),t[76]=U,t[77]=q,t[78]=J):J=t[78];let Y;t[79]===i?Y=t[80]:(Y=i.formatMessage(K.verificationFormLabel),t[79]=i,t[80]=Y);let X;t[81]!==pe||t[82]!==i?(X=pe?(0,G.jsxs)(`div`,{className:`mb-8 flex flex-col items-start gap-2`,children:[(0,G.jsxs)(`div`,{className:`text-token-text-primary flex items-center gap-1 text-base leading-[26px] font-semibold tracking-[-0.32px]`,children:[(0,G.jsx)(y,{...K.accountLabel}),(0,G.jsx)(ce,{content:i.formatMessage(K.accountTooltip),contentLayout:`multi-line`,showOnTouch:!0,side:`bottom-end`,children:e=>(0,G.jsx)(`button`,{...e,"aria-label":i.formatMessage(K.accountTooltip),className:`interactive-button text-token-text-secondary hover:text-token-text-primary flex size-5 shrink-0 items-center justify-center rounded-sm max-sm:-m-3.5 max-sm:size-12`,type:`button`,children:(0,G.jsx)(me,{"aria-hidden":`true`,className:`icon-sm`})})})]}),(0,G.jsx)(`span`,{className:`bg-token-bg-tertiary text-token-text-tertiary max-w-full rounded-lg px-3 py-2 text-base leading-[21px] font-medium tracking-[-0.32px] break-all`,children:pe})]}):null,t[81]=pe,t[82]=i,t[83]=X):X=t[83];let Z;t[84]!==R||t[85]!==Me||t[86]!==i||t[87]!==O||t[88]!==V?(Z=V&&O?(0,G.jsx)(ke,{onSubmitted:R,onSuccess:Me,verificationId:O,verificationUrl:V}):(0,G.jsx)(`div`,{"aria-busy":`true`,"aria-label":i.formatMessage(K.loadingLabel),className:`min-h-[100px] w-full`,role:`status`}),t[84]=R,t[85]=Me,t[86]=i,t[87]=O,t[88]=V,t[89]=Z):Z=t[89];let Q;t[90]!==Y||t[91]!==X||t[92]!==Z?(Q=(0,G.jsxs)(`section`,{"aria-label":Y,className:`min-w-0 px-8 pt-8 lg:px-0 lg:pt-0`,children:[X,Z]}),t[90]=Y,t[91]=X,t[92]=Z,t[93]=Q):Q=t[93];let $;return t[94]!==J||t[95]!==Q?($=(0,G.jsx)(`main`,{className:`mx-auto w-full max-w-[1440px] pb-16 lg:px-12 lg:pt-[78px]`,children:(0,G.jsxs)(`div`,{className:`mx-auto grid w-full max-w-[1200px] grid-cols-1 lg:grid-cols-[minmax(0,618px)_minmax(0,493px)] lg:gap-[89px]`,children:[J,Q]})}),t[94]=J,t[95]=Q,t[96]=$):$=t[96],$}var Re,W,G,ze,Be,K,q=e((()=>{Re=x(),pe(),C(),xe(),Ne(),w(),D(),E(),ge(),O(),fe(),m(),o(),p(),r(),S(),i(),W=t(b()),ie(),re(),G=_(),ze=`https://cdn.openai.com/chatgpt/ctf-cdn/students-2026/verification-campus-lawn-e5c8ee276936.webp`,Be=`students_2026_preview`,K=v({title:{id:`chatgpt.students.back_to_school_2026.embedded_verification.title.work.four_month`,defaultMessage:`Get 4 months of ChatGPT Work free`},desktopTitle:{id:`chatgpt.students.back_to_school_2026.embedded_verification.title.desktop.work.four_month`,defaultMessage:`Study. Build. Launch. Get 4 months of ChatGPT Work on us.`},description:{id:`chatgpt.students.back_to_school_2026.embedded_verification.description.college`,defaultMessage:`An $80 value for eligible U.S. college students. Verify your student status to claim.`},desktopDescription:{id:`chatgpt.students.back_to_school_2026.embedded_verification.description.desktop.college`,defaultMessage:`An $80 value for eligible U.S. college students. Verify your student status to claim.`},verificationHelp:{id:`chatgpt.students.back_to_school_2026.embedded_verification.help`,defaultMessage:`How does verifying work?`},verificationFormLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.form.label`,defaultMessage:`Student verification form`},accountLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.account.label`,defaultMessage:`This offer will be applied to your ChatGPT account`},accountTooltip:{id:`chatgpt.students.back_to_school_2026.embedded_verification.account.tooltip`,defaultMessage:`You’re currently logged in with this account. To switch accounts, log out first.`},artworkAlt:{id:`chatgpt.students.back_to_school_2026.embedded_verification.artwork.alt.campus_lawn`,defaultMessage:`Students sitting together on a college campus lawn`},loadingLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.loading`,defaultMessage:`Loading student verification`}})})),J,Y,X,Z,Q,$,Ve=e((()=>{re(),J=x(),A(),q(),T(),Y=_(),X={hasRouteMeta:!0},Z=()=>[{title:`Student verification | ChatGPT`},{name:`robots`,content:`noindex, nofollow`}],Q=ae(function(){"use forget";let e=(0,J.c)(6),{headerNavData:t,locale:n,sheerIdProgramId:r}=g(),i;e[0]===r?i=e[1]:(i=(0,Y.jsx)(Pe,{sheerIdProgramId:r}),e[0]=r,e[1]=i);let a;return e[2]!==t||e[3]!==n||e[4]!==i?(a=(0,Y.jsx)(j,{headerNavData:t,locale:n,slug:`students/verify`,children:i}),e[2]=t,e[3]=n,e[4]=i,e[5]=a):a=e[5],a}),$=oe(Ce)}));e((()=>{Ve()}))();export{$ as ErrorBoundary,Q as default,X as handle,Z as meta};
//# sourceMappingURL=students_.verify-b2nmqap1.js.map