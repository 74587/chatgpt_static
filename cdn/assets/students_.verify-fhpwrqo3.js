import{n as e,s as t}from"./f025431a-ehagpvg3m4e1cduv.js";import{EG as n,M_ as r,TG as i,hq as a,iG as o,j_ as s,lG as c,m2 as l,mq as u,o6 as d,p2 as f,vG as p,vz as m,xz as ee,yG as h}from"./4813494d-gzgth5b0mjmplu0i.js";import{At as g,Bt as te,Et as ne,Fn as _,In as v,Mn as re,Nn as ie,On as y,Pn as ae,Rt as oe,Z as b,bn as x,zt as se}from"./2340486e-baqct44cv17onimj.js";import{Ep as S,OBt as ce,an as le,bp as ue,kBt as C,mn as w,nvt as de,pn as fe,rvt as pe,wp as me}from"./conversation-small-dg1eim73heyq8lh8.js";import{Oy as he,ky as T}from"./30901919-icoej5sxf9a1zjrs.js";import{n as ge,t as _e}from"./6105d6cc-nfux7q6g12uh6gw0.js";import{n as ve,t as E}from"./9bfdcf20-fbiq4nap511v1e8j.js";import{a as ye,l as D,n as be,o as xe,r as O,t as k,u as Se}from"./d4df9516-ix5019vzigaiv3bf.js";import{a as Ce,i as we}from"./1dd38b87-gvofskrul6ur3p6l.js";import{n as Te,t as Ee}from"./759cd6d0-dymqh25csnp6eatd.js";function A(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function De(e,t){try{let n=new URL(e);return n.origin!==R||n.username!==``||n.password!==``||!/^\/verify\/[^/]+\/?$/.test(n.pathname)||n.searchParams.getAll(`verificationId`).length!==1||n.searchParams.get(`verificationId`)!==t?null:(n.hash=``,n)}catch{return null}}function j(){let e=new URL(window.location.origin);return e.pathname=window.location.pathname,e.searchParams.set(`campaign`,me),e}function M(e){e.contentWindow?.postMessage({action:`setOptions`,options:{customCss:`${V}${H}`}},R)}function Oe(e){"use forget";let t=(0,F.c)(21),{verificationUrl:n,verificationId:r,onSubmitted:i,onSuccess:o}=e,s=ae(),c=a(),l=(0,I.useRef)(null),u=(0,I.useRef)(null),[d]=(0,I.useState)(P),f;if(t[0]!==d||t[1]!==c||t[2]!==r||t[3]!==n){bb0:{if(!c||d==null){f=null;break bb0}let e=De(n,r);if(e==null){f=null;break bb0}e.searchParams.set(`verificationIframeUid`,d),e.searchParams.set(`installPageUrl`,j().toString()),e.searchParams.set(`installType`,`cdn_inline_iframe`),f=e.toString()}t[0]=d,t[1]=c,t[2]=r,t[3]=n,t[4]=f}else f=t[4];let p=f,m,ee;if(t[5]!==d||t[6]!==p||t[7]!==i||t[8]!==o||t[9]!==r?(m=()=>{if(d==null||p==null)return;let e=e=>{let t=l.current;if(t==null||e.origin!==R||e.source!==t.contentWindow||!A(e.data)||e.data.verificationIframeUid!==d)return;let n=e.data.action;if(A(n)&&n.type===`updateHeight`){if(typeof n.height!=`number`||!Number.isFinite(n.height))return;let e=Math.min(B,Math.max(z,Math.round(n.height)));t.style.height=`${e}px`,t.scrolling=n.height>B?`auto`:`no`;return}if(!A(n)||n.type!==`hook`||!A(n.hook)||!A(n.hook.data)||n.hook.data.verificationId!==r)return;let a=n.hook.data.currentStep,s=n.hook.name===`ON_VERIFICATION_STEP_CHANGE`&&typeof a==`string`&&a!==`collectStudentPersonalInfo`&&a!==`collectPersonalInfo`,c=n.hook.name===`ON_VERIFICATION_SUCCESS`&&a===`success`;if(!(!s&&!c)){if(u.current!==r){u.current=r;try{i?.()}catch{}}c&&o()}};return window.addEventListener(`message`,e),()=>{window.removeEventListener(`message`,e)}},ee=[d,p,i,o,r],t[5]=d,t[6]=p,t[7]=i,t[8]=o,t[9]=r,t[10]=m,t[11]=ee):(m=t[10],ee=t[11]),(0,I.useEffect)(m,ee),p==null){let e;t[12]===s?e=t[13]:(e=s.formatMessage(U.loadingLabel),t[12]=s,t[13]=e);let n;return t[14]===e?n=t[15]:(n=(0,L.jsx)(`div`,{"aria-busy":`true`,"aria-label":e,className:`min-h-[100px] w-full`,role:`status`}),t[14]=e,t[15]=n),n}let h;t[16]===s?h=t[17]:(h=s.formatMessage(U.verificationTitle),t[16]=s,t[17]=h);let g;return t[18]!==p||t[19]!==h?(g=(0,L.jsx)(`iframe`,{ref:l,allow:`camera ${R}`,className:`block min-h-[100px] w-full border-0`,onLoad:N,referrerPolicy:`no-referrer`,src:p,title:h}),t[18]=p,t[19]=h,t[20]=g):g=t[20],g}function N(e){M(e.currentTarget)}function P(){return typeof window>`u`?null:globalThis.crypto.randomUUID()}var F,I,L,R,z,B,V,H,U,ke=e((()=>{F=x(),S(),u(),I=t(v()),ie(),L=_(),R=`https://services.sheerid.com`,z=100,B=2e3,V=`
...
`,U=re({loadingLabel:{id:`chatgpt.students.back_to_school_2026.embedded_form.loading`,defaultMessage:`Loading student verification`},verificationTitle:{id:`chatgpt.students.back_to_school_2026.embedded_form.title`,defaultMessage:`Student verification`}})}));function Ae(e){"use forget";let t=(0,Me.c)(8),{sheerIdProgramId:n}=e,i=h(),a=i?.id??null,o=(0,K.useRef)(a),s,c;t[0]===a?(s=t[1],c=t[2]):(s=()=>{if(a==null)return;let e=o.current;o.current=a,e!=null&&e!==a&&(k.clearModalError(),k.setIsLoading(!1))},c=[a],t[0]=a,t[1]=s,t[2]=c),r(s,c);let l;t[3]===Symbol.for(`react.memo_cache_sentinel`)?(l=[],t[3]=l):l=t[3],(0,K.useEffect)(je,l);let u=i?.id??`no-account`,d;return t[4]!==i||t[5]!==n||t[6]!==u?(d=(0,q.jsx)(G,{currentAccount:i,sheerIdProgramId:n},u),t[4]=i,t[5]=n,t[6]=u,t[7]=d):d=t[7],d}function je(){let e=W;return window.addEventListener(`pageshow`,e),()=>window.removeEventListener(`pageshow`,e)}function W(e){e.persisted&&window.location.reload()}function G(e){"use forget";let t=(0,Me.c)(92),{currentAccount:r,sheerIdProgramId:i}=e,a=ae(),s=g(),c=p(),u=ee(),[f]=oe(),m;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(m=l(),t[0]=m):m=t[0];let h=m,te=(0,K.useRef)(!1),ne=(0,K.useRef)(!1),_=(0,K.useRef)(!0),v;t[1]===f?v=t[2]:(v=f.get(Pe),t[1]=f,t[2]=v);let re=v,ie=`/students/2026#trigger_students-2026-faq-verification`,b;t[3]===re?b=t[4]:(b=new URLSearchParams({campaign:me}).toString(),t[3]=re,t[4]=b);let x=`/students/claim?${b}`,se;t[5]===u?.email?se=t[6]:(se=h&&(u?.email?.trim()||d()?.user?.email?.trim())||null,t[5]=u?.email,t[6]=se);let S=se,C;t[7]!==x||t[8]!==i?(C={...ue,landingPath:x,sheerIdProgramId:i},t[7]=x,t[8]=i,t[9]=C):C=t[9];let w=C,pe;t[10]!==r||t[11]!==w?(pe=r!=null&&(!r.isPersonalAccount()||w.blocksMobileStoreSubscribers&&ce(r)),t[10]=r,t[11]=w,t[12]=pe):pe=t[12];let T=pe,ge=h&&r!=null&&!T,ve;t[13]===ge?ve=t[14]:(ve={enabled:ge,reportRefreshErrors:!0},t[13]=ge,t[14]=ve);let E=Se(w,ve),D=E.name===`needs-verification`?E.verificationId??null:null,O=E.name===`needs-verification`?E.accountVerificationId??null:null,k=xe(D,O,w),we,Te;t[15]===Symbol.for(`react.memo_cache_sentinel`)?(Te=()=>(_.current=!0,()=>{_.current=!1}),we=[],t[15]=we,t[16]=Te):(we=t[15],Te=t[16]),(0,K.useEffect)(Te,we);let Ee,A;t[17]===x?(Ee=t[18],A=t[19]):(Ee=()=>{h||te.current||(te.current=!0,n({callbackUrl:x,fallbackScreenHint:`login`}))},A=[x,h],t[17]=x,t[18]=Ee,t[19]=A),(0,K.useEffect)(Ee,A);let De;t[20]!==c.isError||t[21]!==c.isFetching||t[22]!==c.isSuccess||t[23]!==x||t[24]!==r||t[25]!==E.name||t[26]!==T||t[27]!==s?(De=()=>{if(!h)return;let e=r==null&&!c.isFetching&&(c.isError||c.isSuccess),t=E.name===`coming-soon`||E.name===`error`||E.name===`verified`||E.name===`enrolled`;(e||T||t)&&s(x,{replace:!0})},t[20]=c.isError,t[21]=c.isFetching,t[22]=c.isSuccess,t[23]=x,t[24]=r,t[25]=E.name,t[26]=T,t[27]=s,t[28]=De):De=t[28];let j;t[29]!==c.isError||t[30]!==c.isFetching||t[31]!==c.isSuccess||t[32]!==x||t[33]!==r||t[34]!==E||t[35]!==T||t[36]!==s?(j=[c.isError,c.isFetching,c.isSuccess,x,r,E,T,h,s],t[29]=c.isError,t[30]=c.isFetching,t[31]=c.isSuccess,t[32]=x,t[33]=r,t[34]=E,t[35]=T,t[36]=s,t[37]=j):j=t[37],(0,K.useEffect)(De,j);let M,N;t[38]!==O||t[39]!==x||t[40]!==r||t[41]!==E.name||t[42]!==T||t[43]!==s||t[44]!==D||t[45]!==k?(M=()=>{!h||r==null||T||E.name!==`needs-verification`||D!=null&&O!=null||ne.current||(ne.current=!0,k().then(()=>{!_.current||o()?.id!==r.id||ye.getState().modalErrorMessage==null||s(x,{replace:!0,state:{students2026VerificationError:!0}})}))},N=[O,x,r,E.name,T,h,s,D,k],t[38]=O,t[39]=x,t[40]=r,t[41]=E.name,t[42]=T,t[43]=s,t[44]=D,t[45]=k,t[46]=M,t[47]=N):(M=t[46],N=t[47]),(0,K.useEffect)(M,N);let P;t[48]===r?P=t[49]:(P=()=>{let e=r?.normalizedAccountUserId;r==null||typeof e!=`string`||Ce(`verification_submitted`,{identity:{accountId:r.id,accountUserId:e}})},t[48]=r,t[49]=P);let F=P,I;t[50]!==x||t[51]!==s?(I=()=>{s(fe(x,le),{replace:!0})},t[50]=x,t[51]=s,t[52]=I):I=t[52];let L=I,R;t[53]!==O||t[54]!==x||t[55]!==r||t[56]!==T||t[57]!==i||t[58]!==D?(R=h&&r!=null&&D&&O&&!T?be(i,`${window.location.origin}${fe(x,le)}`,D,O):null,t[53]=O,t[54]=x,t[55]=r,t[56]=T,t[57]=i,t[58]=D,t[59]=R):R=t[59];let z=R,B;t[60]===a?B=t[61]:(B=a.formatMessage(J.artworkAlt),t[60]=a,t[61]=B);let V;t[62]===B?V=t[63]:(V=(0,q.jsx)(_e,{altText:B,assetUrl:Ne,mediaClassName:`h-full w-full object-cover`,rounding:`none`,wrapperClassName:`order-first h-[228px] w-full lg:order-last lg:mt-14 lg:h-[456px] lg:rounded-[32px]`}),t[62]=B,t[63]=V);let H;t[64]===Symbol.for(`react.memo_cache_sentinel`)?(H=(0,q.jsx)(`span`,{className:`lg:hidden`,children:(0,q.jsx)(y,{...J.title})}),t[64]=H):H=t[64];let U;t[65]===Symbol.for(`react.memo_cache_sentinel`)?(U=(0,q.jsxs)(`h1`,{className:`text-token-text-primary text-[32px] leading-[1.14] font-medium tracking-[-0.64px] lg:text-[64px] lg:leading-none lg:tracking-[-1.28px]`,children:[H,(0,q.jsx)(`span`,{className:`hidden lg:inline`,children:(0,q.jsx)(y,{...J.desktopTitle})})]}),t[65]=U):U=t[65];let ke;t[66]===Symbol.for(`react.memo_cache_sentinel`)?(ke=(0,q.jsx)(`span`,{className:`lg:hidden`,children:(0,q.jsx)(y,{...J.description})}),t[66]=ke):ke=t[66];let Ae;t[67]===Symbol.for(`react.memo_cache_sentinel`)?(Ae=(0,q.jsx)(`span`,{className:`hidden lg:inline`,children:(0,q.jsx)(y,{...J.desktopDescription})}),t[67]=Ae):Ae=t[67];let je;t[68]===Symbol.for(`react.memo_cache_sentinel`)?(je=(0,q.jsx)(y,{...J.verificationHelp}),t[68]=je):je=t[68];let W;t[69]===ie?W=t[70]:(W=(0,q.jsxs)(`div`,{className:`px-8 pt-8 lg:px-0 lg:pt-0`,children:[U,(0,q.jsxs)(`p`,{className:`text-token-text-secondary mt-6 text-base leading-[26px]`,children:[ke,Ae,(0,q.jsx)(`a`,{className:`text-token-text-secondary ms-1 underline underline-offset-2`,href:ie,rel:`noopener noreferrer`,target:`_blank`,children:je})]})]}),t[69]=ie,t[70]=W);let G;t[71]!==V||t[72]!==W?(G=(0,q.jsxs)(`section`,{className:`flex min-w-0 flex-col`,children:[V,W]}),t[71]=V,t[72]=W,t[73]=G):G=t[73];let Y;t[74]===a?Y=t[75]:(Y=a.formatMessage(J.verificationFormLabel),t[74]=a,t[75]=Y);let X;t[76]!==S||t[77]!==a?(X=S?(0,q.jsxs)(`div`,{className:`mb-8 flex flex-col items-start gap-2`,children:[(0,q.jsxs)(`div`,{className:`text-token-text-primary flex items-center gap-1 text-base leading-[26px] font-semibold tracking-[-0.32px]`,children:[(0,q.jsx)(y,{...J.accountLabel}),(0,q.jsx)(de,{content:a.formatMessage(J.accountTooltip),contentLayout:`multi-line`,showOnTouch:!0,side:`bottom-end`,children:e=>(0,q.jsx)(`button`,{...e,"aria-label":a.formatMessage(J.accountTooltip),className:`interactive-button text-token-text-secondary hover:text-token-text-primary flex size-5 shrink-0 items-center justify-center rounded-sm max-sm:-m-3.5 max-sm:size-12`,type:`button`,children:(0,q.jsx)(he,{"aria-hidden":`true`,className:`icon-sm`})})})]}),(0,q.jsx)(`span`,{className:`bg-token-bg-tertiary text-token-text-tertiary max-w-full rounded-lg px-3 py-2 text-base leading-[21px] font-medium tracking-[-0.32px] break-all`,children:S})]}):null,t[76]=S,t[77]=a,t[78]=X):X=t[78];let Z;t[79]!==F||t[80]!==L||t[81]!==a||t[82]!==D||t[83]!==z?(Z=z&&D?(0,q.jsx)(Oe,{onSubmitted:F,onSuccess:L,verificationId:D,verificationUrl:z}):(0,q.jsx)(`div`,{"aria-busy":`true`,"aria-label":a.formatMessage(J.loadingLabel),className:`min-h-[100px] w-full`,role:`status`}),t[79]=F,t[80]=L,t[81]=a,t[82]=D,t[83]=z,t[84]=Z):Z=t[84];let Q;t[85]!==Y||t[86]!==X||t[87]!==Z?(Q=(0,q.jsxs)(`section`,{"aria-label":Y,className:`min-w-0 px-8 pt-8 lg:px-0 lg:pt-0`,children:[X,Z]}),t[85]=Y,t[86]=X,t[87]=Z,t[88]=Q):Q=t[88];let $;return t[89]!==G||t[90]!==Q?($=(0,q.jsx)(`main`,{className:`mx-auto w-full max-w-[1440px] pb-16 lg:px-12 lg:pt-[78px]`,children:(0,q.jsxs)(`div`,{className:`mx-auto grid w-full max-w-[1200px] grid-cols-1 lg:grid-cols-[minmax(0,618px)_minmax(0,493px)] lg:gap-[89px]`,children:[G,Q]})}),t[89]=G,t[90]=Q,t[91]=$):$=t[91],$}var Me,K,q,Ne,Pe,J,Y=e((()=>{Me=x(),T(),pe(),ge(),ke(),S(),D(),we(),O(),w(),c(),i(),m(),f(),C(),s(),K=t(v()),ie(),b(),q=_(),Ne=`https://cdn.openai.com/chatgpt/ctf-cdn/students-2026/verification-campus-lawn-e5c8ee276936.webp`,Pe=`students_2026_preview`,J=re({title:{id:`chatgpt.students.back_to_school_2026.embedded_verification.title.work.four_month`,defaultMessage:`Get 4 months of ChatGPT Work free`},desktopTitle:{id:`chatgpt.students.back_to_school_2026.embedded_verification.title.desktop.work.four_month`,defaultMessage:`Study. Build. Launch. Get 4 months of ChatGPT Work on us.`},description:{id:`chatgpt.students.back_to_school_2026.embedded_verification.description.college`,defaultMessage:`An $80 value for eligible U.S. college students. Verify your student status to claim.`},desktopDescription:{id:`chatgpt.students.back_to_school_2026.embedded_verification.description.desktop.college`,defaultMessage:`An $80 value for eligible U.S. college students. Verify your student status to claim.`},verificationHelp:{id:`chatgpt.students.back_to_school_2026.embedded_verification.help`,defaultMessage:`How does verifying work?`},verificationFormLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.form.label`,defaultMessage:`Student verification form`},accountLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.account.label`,defaultMessage:`This offer will be applied to your ChatGPT account`},accountTooltip:{id:`chatgpt.students.back_to_school_2026.embedded_verification.account.tooltip`,defaultMessage:`You’re currently logged in with this account. To switch accounts, log out first.`},artworkAlt:{id:`chatgpt.students.back_to_school_2026.embedded_verification.artwork.alt.campus_lawn`,defaultMessage:`Students sitting together on a college campus lawn`},loadingLabel:{id:`chatgpt.students.back_to_school_2026.embedded_verification.loading`,defaultMessage:`Loading student verification`}})})),X,Z,Q,$,Fe,Ie,Le=e((()=>{b(),X=x(),Te(),Y(),ve(),Z=_(),Q={hasRouteMeta:!0},$=()=>[{title:`Student verification | ChatGPT`},{name:`robots`,content:`noindex, nofollow`}],Fe=se(function(){"use forget";let e=(0,X.c)(6),{headerNavData:t,locale:n,sheerIdProgramId:r}=ne(),i;e[0]===r?i=e[1]:(i=(0,Z.jsx)(Ae,{sheerIdProgramId:r}),e[0]=r,e[1]=i);let a;return e[2]!==t||e[3]!==n||e[4]!==i?(a=(0,Z.jsx)(Ee,{headerNavData:t,locale:n,slug:`students/verify`,children:i}),e[2]=t,e[3]=n,e[4]=i,e[5]=a):a=e[5],a}),Ie=te(E)}));e((()=>{Le()}))();export{Ie as ErrorBoundary,Fe as default,Q as handle,$ as meta};
//# sourceMappingURL=students_.verify-fhpwrqo3.js.map